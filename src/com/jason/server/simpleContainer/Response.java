...
public class Response implements ServletResponse
{
	...
	/* Implementation of ServletResponse - Servlet Specification 3.1 */
 ...
 */
     ...
     */
     ...
     //package the socket's output into the writer to write
     //character in response
    public PrintWriter getWriter() throws IOException
    {
    		writer = new PrintWriter(out,true);//allow autoflush
    		return writer; 
    }
